...
public class UserCourseResource {
    ...
    public ResponseEntity<UserCourse> updateUserCourse(
        ...
        UserCourse result = userCourseService.update(userCourse);
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, userCourse.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<UserCourse> partialUpdateUserCourse(
        ...
        Optional<UserCourse> result = userCourseService.partialUpdate(userCourse);

        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, userCourse.getId().toString())
        );
    }
    ...
    /**
     * {@code GET  /user-courses/count} : count all the userCourses.
     *
     * @param criteria the criteria which the requested entities should match.
