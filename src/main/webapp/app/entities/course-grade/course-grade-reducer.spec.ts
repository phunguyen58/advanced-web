...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COURSEGRADE_LIST actions', async () => {
    ...
    it('dispatches FETCH_COURSEGRADE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COURSEGRADE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COURSEGRADE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COURSEGRADE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COURSEGRADE actions', async () => {
      const expectedActions = [
        {
