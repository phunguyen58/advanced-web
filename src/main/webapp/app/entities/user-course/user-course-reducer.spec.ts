...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERCOURSE_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERCOURSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERCOURSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERCOURSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERCOURSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERCOURSE actions', async () => {
      const expectedActions = [
        {
