...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './grade-composition.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GRADECOMPOSITION_LIST actions', async () => {
    ...
    it('dispatches FETCH_GRADECOMPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GRADECOMPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GRADECOMPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GRADECOMPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GRADECOMPOSITION actions', async () => {
      const expectedActions = [
        {
