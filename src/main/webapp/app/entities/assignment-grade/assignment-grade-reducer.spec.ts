...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ASSIGNMENTGRADE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ASSIGNMENTGRADE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ASSIGNMENTGRADE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ASSIGNMENTGRADE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ASSIGNMENTGRADE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ASSIGNMENTGRADE actions', async () => {
      const expectedActions = [
        {
