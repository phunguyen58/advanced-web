...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GRADESTRUCTURE_LIST actions', async () => {
    ...
    it('dispatches FETCH_GRADESTRUCTURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GRADESTRUCTURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GRADESTRUCTURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GRADESTRUCTURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GRADESTRUCTURE actions', async () => {
      const expectedActions = [
        {
