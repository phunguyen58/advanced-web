...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CATEGORIES_LIST actions', async () => {
    ...
    it('dispatches FETCH_CATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CATEGORIES actions', async () => {
      const expectedActions = [
        {
