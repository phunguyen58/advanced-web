...
export const CategoriesDeleteDialog = () => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(categoriesEntity.id));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="webApp.categories.delete.question">
        <Translate contentKey="webApp.categories.delete.question" interpolate={{ id: categoriesEntity.id }}>
