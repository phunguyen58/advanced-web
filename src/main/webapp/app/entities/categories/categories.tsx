  ...
  return (
    <div>
      <h2 id="categories-heading" data-cy="CategoriesHeading">
        <Translate contentKey="webApp.categories.home.title">Categories</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="webApp.categories.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/categories/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="webApp.categories.home.createLabel">Create new Categories</Translate>
          </Link>
        </div>
      </h2>
        ...
        {categoriesList && categoriesList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="webApp.categories.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('categoryName')}>
                  <Translate contentKey="webApp.categories.categoryName">Category Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('categoryUrl')}>
                  <Translate contentKey="webApp.categories.categoryUrl">Category Url</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('createdBy')}>
                  <Translate contentKey="webApp.categories.createdBy">Created By</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('createdTime')}>
                  <Translate contentKey="webApp.categories.createdTime">Created Time</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {categoriesList.map((categories, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{categories.categoryUrl}</td>
                  <td>{categories.createdBy}</td>
                  <td>
                    {categories.createdTime ? <TextFormat type="date" value={categories.createdTime} format={APP_DATE_FORMAT} /> : null}
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="webApp.categories.home.notFound">No Categories found</Translate>
            </div>
          )
        )}
      </div>
