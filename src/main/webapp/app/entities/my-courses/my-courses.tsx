...
import { TextFormat, getSortState, JhiPagination, JhiItemCount, Translate } from 'react-jhipster';
  ...
  return (
    <div className="ps-4">
      <h2 id="course-heading" data-cy="CourseHeading">
        <Translate contentKey="webApp.course.home.myCourses">Courses</Translate>
      </h2>
