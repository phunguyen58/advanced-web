...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GRADEREVIEW_LIST actions', async () => {
    ...
    it('dispatches FETCH_GRADEREVIEW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GRADEREVIEW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GRADEREVIEW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GRADEREVIEW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GRADEREVIEW actions', async () => {
      const expectedActions = [
        {
